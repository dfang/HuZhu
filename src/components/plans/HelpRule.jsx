...
=======
            trigger: <li><i>加入条件</i> <span>出生后30天-12周岁，身体健康</span></li>,
>>>>>>> xiugaijiantou
        ...
        {
            trigger: <li>事件范围 <span>白血病、癌症等50种大病</span></li>,
        ...
        {
            trigger: <li>最高获捐 <span><em>30万元</em></span></li>,
...
=======
            trigger: <li>分摊规则 <span>单次不超过<em>3元</em>，每年约<em>150元</em></span></li>,
...
>>>>>>> xiugaijiantou
        ...
        {
            trigger: <li>余额要求 <span>账户余额不低于1元即可</span></li>,
        ...
        {
            trigger: <li>等待期 <span className="wait-font">180天（为防止带病加入）</span></li>,
            content: <div className="hidden-ctn">
