            ...
            <ul>
                <Collapsible trigger="一、说明">
                    <li className="convention-hide">
                        <p>
                           1、宝健康互助是武汉守正科技有限公司（以下简称“本公司”）为了帮助实现人民群众“病有所医、病有所养”而设立的网络互助平台。基于“人人为我、我为人人”、“健康我帮人、有难众帮我”的公益理念，互助金的用途聚焦于重大疾病和意外伤残的治疗与康复以及意外身故后其家庭的救助。互助平台包括但不限于宝健康互助网站、APP和微信公众号。本公约是宝健康互助平台和会员（以下或简称“您”）共同遵守的约定。
                           <b>您加入宝健康互助平台前请务必认真阅读本公约的全部内容。本公约一经您确认并同意接受，即视为您已完全同意并接受本公约约束，承诺遵守本公约约定，届时您不应以未阅读本公约的内容主张本公约无效；</b><br/>
                           2、如会员发现任何机构或个人存在违反本公约约定的行为，请及时通知宝健康互助平台;
                           3、加入互助计划的本质，是向互助计划中随机发生的符合互助条件的会员单向的赠予行为，不能预期获得确定的风险保障回报。</p>
                    </li>
                </Collapsible>
                ...
                <Collapsible trigger="三、本公约的构成及效力">
                  <li className="convention-hide">
                      <p><b>1、宝健康互助平台有权根据实际情况适时修订本公约及各互助计划规则，一经修订，将会用修订后的条款版本完全替代修订前的条款版本，并通过原有方式向所有会员公布。变更后的条款一经在宝健康互助平台上公示，即产生法律效力，条款修订后的互助事件及相关一切服务都将按照新条款执行；</b></p>
                      <p>2、如您对本公约有任何疑问，应向宝健康互助平台咨询。您不应以未阅读或不接受本公约的内容为由，主张本公约无效或要求撤销本公约；</p>
                      <p>3、<b>您应该按照本公约约定行使权利并履行义务。如您不能接受本公约的约定，包括但不限于不能接受修订后的公约，则您应立即停止使用宝健康互助平台针对会员提供的服务。如您继续使用宝健康互助平台针对会员提供的服务，则表示您同意并接受本公约的约束。</b></p>
                  </li>
               </Collapsible>
