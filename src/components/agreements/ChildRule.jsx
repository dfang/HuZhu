            ...
            <ul>
                ...
                <Collapsible trigger="第六条 互助申请流程">
                  <li className="ipList">
                      ...
                      6.2 互助申请人在宝健康互助平台受理申请后7日内按照宝健康互助平台的要求提交各类互助事件证明材料。</p>
                  </li>
                </Collapsible>

                <Collapsible trigger="第七条 互助款拨款流程">
                  <li className="ipList">
                      <p>7.1 宝健康互助平台收齐互助事件证明材料后委托独立第三方评估机构或者具有相关专业知识的人员，对互助事件进行评估和鉴定，形成调查结论，有争议或疑难的事件，宝健康互助平台专家进行审定；<br/>
                      ...
                      7.5 若有会员在公示期间内有依据地对互助事件提出异议，宝健康互助平台根据情况要求互助申请人解释说明或补充提交材料，并对互助事件进行再次审定。</p>
                  </li>
                </Collapsible>
                ...
                <Collapsible trigger="第八条 申请互助所需材料">
                  <li className="ipList">
                    ...
                    8.6 以上证明和资料不完整，或者需要进一步确定互助事件的性质、原因的，宝健康互助平台将及时通知互助申请人补充提供有关证明和资料。</p>
                  </li>
                </Collapsible>

                <Collapsible trigger="第九条 信息披露要求">
                  <li className="ipList">
                      <p>9.1 为确认互助事件真实性，会员同意宝健康互助平台向其他会员公示互助申请人的真实身份，事件发生的过程和详细情况，披露申请互助所提供的相关材料；<br/>
                      9.2 对于宝健康互助平台公示的符合本计划规则的互助事件，其他会员可以咨询或合法调查。</p>
                  </li>
                </Collapsible>

                <Collapsible trigger="第十条 其他重要事项">
                  <li className="ipList">
                      <p><b>10.1 宝健康互助平台不对每次互助的互助金总额做出承诺；</b><br/>
                      ...
                      10.12 本计划规则的解释权归武汉守正科技有限公司及宝健康互助平台所有。</p>
                  </li>
                </Collapsible>
                ...
                <Collapsible trigger="第十一条 释义">
                  <li className="ipList">
                      ...
                      11.13 本规则未释明的释义以<a>《宝健康互助会员公约》</a>约定为准。<br/></p>
                  </li>
                </Collapsible>
